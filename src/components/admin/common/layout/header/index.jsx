      ...
      <div className="max-w-[1080px] container flex flex-wrap justify-between items-center mx-auto">
        ...
        >
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            <li>
              <Link to={RouteRegistry.adminDashboard.path} className={`block py-2 pr-4 pl-3 rounded md:bg-transparent ${pathname === RouteRegistry.adminDashboard.path ? 'md:text-[#b1b845] text-white bg-[#b1b845]' : 'text-[#6d86a8]'} md:hover:text-[#b1b845] md:p-0`}>
                {RouteRegistry.adminDashboard.title}
              </Link>
            </li>
            <li>
              <Link to={RouteRegistry.adminPlaces.path} className={`block py-2 pr-4 pl-3 rounded md:bg-transparent ${pathname === RouteRegistry.adminPlaces.path ? 'md:text-[#b1b845] text-white bg-[#b1b845]' : 'text-[#6d86a8]'} md:hover:text-[#b1b845] md:p-0`}>
                {RouteRegistry.adminPlaces.title}
              </Link>
            </li>
            <li>
              <Link to={RouteRegistry.adminGuides.path} className={`block py-2 pr-4 pl-3 rounded md:bg-transparent ${pathname === RouteRegistry.adminGuides.path ? 'md:text-[#b1b845] text-white bg-[#b1b845]' : 'text-[#6d86a8]'} md:hover:text-[#b1b845] md:p-0`}>
                {RouteRegistry.adminGuides.title}
              </Link>
            </li>
            <li>
